...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		public static void main(String[] args) {
			...
			String heightToRide = JOptionPane.showInputDialog("Enter your height in inches, please.");
			// Uncomment the line below...
			int heightAsInt = Integer.parseInt(heightToRide);
				if( heightAsInt >= 42 ) {
					JOptionPane.showMessageDialog(null, "HURRAY! You are tall enough to ride the rollercoaster!");
				}
				else {
					JOptionPane.showMessageDialog(null, "You must be at lesast 42 inches to ride the rollercoaster...");
				}
